      ...
      <div className="h-full px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-2 text-muted-foreground">
            ...
            <span className="text-xs uppercase">UTC</span>
          </div>
          ...
          <div className="flex items-center gap-3 pl-4 border-l border-border">
            ...
            <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-primary/30 to-primary/10 border border-primary/20 flex items-center justify-center">
              <span className="font-mono text-sm font-semibold text-primary">OC</span>
            </div>
          </div>
        </div>
      </div>
